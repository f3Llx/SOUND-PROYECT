...
<html lang="en">
   ...
   <?php
     ...
     // todos los modals de la configuracion del perfil

     require_once("utilities/settings_rules.php");
      ?>
   <body>
      <!-- INICIO NAV BAR -->
         ...
         <div class="row">
            <div class="col-sm-3 well">
               <div class="well">
                  ...
                  <img src="<?php echo $_SESSION["current_user_img"]; ?>" class="img-circle hvr-bounce-in" height="65" width="65" alt="Avatar">
               </div>
               <div class="well">
            ...
            <div class="col-sm-6">
                     ...
                     <div class="well" style="background-image: url('<?php echo $_SESSION["current_user_banner"];?>');background-size: cover;" >
                        <p style="font-size:45px;color:<?php echo $_SESSION["current_user_color"];?>">.:<?php echo $_SESSION["this_artist"];?>:.</p>
                        <img src="<?php echo $_SESSION["current_user_img"]; ?>" class="img-circle hvr-bounce-in" height="55" width="55" alt="Avatar" id="user_img">
                     </div>
                  ...
                  <?php
                             ...
                             $checkmyartist=$_SESSION['username'];
                             $are_you_an_artistQ = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                             $idk = $are_you_an_artistQ->query("SELECT COUNT(*) FROM user WHERE username='$checkmyartist' && is_artist='1'")->fetch(Pdo::FETCH_COLUMN);
                            if ($idk==1){
                          ...
                          <div class='well text-left '>
                             <h1 class='hvr-forward'>All ".$_SESSION['this_artist']."´s Songs :</h1>
                          </div>
                          <ul class='playlist--list text-left' style='width:100%;max-height:150px;overflow-y: auto;'>";
                                   ...
                                   foreach($newmusicdata as $row2) {
                                       echo"
                                <li  data-id='$newmusicdata3=$newmusicdata3+1 $newmusicdata3' data-audio='".$row2["music"]."'>
                          ...
                          <div class='plyr'>
                           ...
                           echo"<div >
                           <div class='well'>
                           <h1 class='well text-left'>Your Profile is empty</h1>
                               <p class='text-left'>Upload your tracks now to start sharing your music!</p></div>
                           <img src='img/no songs.png' height='300px' width='300px'>
                           </div></div>";
                       }?>
            ...
            <!-- SETTINGSSSS!!!!  -->
             <div class="col-sm-3 well ">
                ...
                <div class="  w3-animate-bottom " style="max-height:660px;overflow-y:auto;">
                        ...
                        <p>Here you can customize your profile as your liking!
                            ...
                            <!--PASSWORD  -->
                                ...
                                <hr style="color: #c5ae29;background-color: #c5ae29;height: 5px;">
                            ...
                            <!--IMAGE  -->
                                ...
                                <h5>Banner!</h5> <a href="#banner_edit" data-toggle="collapse"><span class="glyphicon glyphicon-cog w3-spin"></span></a>
                                <div id="banner_edit" class="collapse">
                                <img src="<?php echo $_SESSION["current_user_banner"];?>" height="35px" width="80px">    
                                <br>
                                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                        Paste your image "URL"!:<br>
                                        <input style="color:black;" type="text" name="edited_banner">
                                            <button class="btn w3-button " type="submit" name="edit_banner">
                                                <span class="glyphicon glyphicon-refresh"></span> ok!
                                            </button>
                                    </form>
                                </div>
    ...
    <!-- Modal -->
<div id="errors_settings" class="modal fade" role="dialog">
  <div class="modal-dialog">
